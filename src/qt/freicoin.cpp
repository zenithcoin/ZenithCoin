...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", FreicoinGUI::tr("A fatal error occured. ZenithCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "ZenithCoin",
    ...
    app.setOrganizationName("ZenithCoin");
    app.setOrganizationDomain("zenithcoin.com");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("ZenithCoin-Qt-testnet");
    else
        app.setApplicationName("ZenithCoin-Qt");
