...
bool parseFreicoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("zenithcoin://"))
    {
        uri.replace(0, 10, "zenithcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ZenithCoin.lnk";
}
...
{
    return GetAutostartDir() / "zenithcoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("ZenithCoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  zenithcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("ZenithCoin-Qt"));
