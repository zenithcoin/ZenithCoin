    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("Zenithcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void FreicoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ZenithCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/freicoin"), tr("&About ZenithCoin"), this);
    aboutAction->setToolTip(tr("Show information about ZenithCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for ZenithCoin"));
...
void FreicoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ZenithCoin client") + QString(" ") + tr("[testnet]"));
...
void FreicoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ZenithCoin client"));
...
void FreicoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZenithCoin network", "", count));
}
...
void FreicoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ZenithCoin address or malformed URI parameters."));
    }
