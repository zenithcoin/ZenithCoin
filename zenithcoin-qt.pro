...
# If BerkeleyDB is in a non-standard location,
# define these:
...
EXTRA_LIB_PATH=c:/MinGW/msys/1.0/local/lib
...
INCLUDEPATH += $$BOOST_INCLUDE_PATH $$BDB_INCLUDE_PATH $$OPENSSL_INCLUDE_PATH $$QRENCODE_INCLUDE_PATH $$EXTRA_INCLUDE_PATH
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,) $$join(EXTRA_LIB_PATH,,-L)
